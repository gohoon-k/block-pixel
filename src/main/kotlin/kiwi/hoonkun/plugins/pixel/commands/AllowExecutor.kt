...
class AllowExecutor(parent: Entry): Executor(parent) {

    override val usage: String = "pixel allow < player >"
    override val description: String = "allows player to use '/pixel' command"
    ...
    override suspend fun exec(sender: CommandSender?, args: List<String>): CommandExecuteResult {
        ...
        parent.logger.log(Level.INFO, "allowed $target as pixel manager")
